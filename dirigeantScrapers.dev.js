    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 46:
          ...
          _context2.next = 50;
          return regeneratorRuntime.awrap(page.evaluate(function () {
            return Array.from(document.querySelectorAll("#staff .row .col-xl-4 .item-player .btn")).map(function (x) {
              return x.getAttribute("href");
            });
          }));
        ...
        case 50:
          ...
          _loop = function _loop(index) {
            var _ref5, _ref6, name, txt, rawTxt, _ref7, _ref8, age, ageTxt, ageRawTxt, _ref9, _ref10, dateNaissance, dateNaissanceTxt, dateNaissanceRawTxt, dateNaissanceRawTxtValid, _ref11, _ref12, lieuNaissance, lieuNaissanceTxt, lieuNaissanceRawTxt, _ref13, _ref14, wilaya, wilayaTxt, wilayaRawTxt, table;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 60:
                    ...
                    console.log(table, ageRawTxt, dateNaissanceRawTxt, lieuNaissanceRawTxt, wilayaRawTxt); // Nom
                    ...
                    worksheet.cell(index + 2, 7).string(wilayaRawTxt); // Fonction

                    if (table.length === 4) {
                      worksheet.cell(index + 2, 8).string(table[2] + " " + table[3]);
                    } else {
                      if (table.length === 5) {
                        worksheet.cell(index + 2, 8).string(table[2] + " " + table[3] + " " + table[4]);
                      } else {
                        if (table.length === 6) {
                          worksheet.cell(index + 2, 8).string(table[2] + " " + table[3] + " " + table[4] + " " + table[5]);
                        } else {
                          if (table.length === 7) {
                            worksheet.cell(index + 2, 8).string(table[2] + " " + table[3] + " " + table[4] + " " + table[5] + " " + table[6]);
                          } else {
                            if (table.length === 8) {
                              worksheet.cell(index + 2, 8).string(table[2] + " " + table[3] + " " + table[4] + " " + table[5] + " " + table[6] + " " + table[7]);
                            } else {
                              worksheet.cell(index + 2, 8).string(table[2]);
                            }
                          }
                        }
                      }
        ...
        case 63:
          //! starts clubs here
          // write into sheet
          workbook.write('dirigeants_H3.xlsx');
          browser.close();
